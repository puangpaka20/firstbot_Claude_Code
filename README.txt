...
===============================================================
ขั้นตอนที่ 3 — Login ด้วยตัวเองครั้งแรก (สำคัญมาก — ทำแค่ครั้งเดียว)
===============================================================

⚠️  ทำขั้นตอนนี้ก่อนรัน batch ไม่งั้น MT5 จะเปิดหน้า Login ขึ้นมาถามเองทุกครั้ง

สาเหตุ: MT5 ที่เพิ่ง install ใหม่ยังไม่รู้จัก Server Address ของโบรกเกอร์
หลังจาก Login ด้วยตัวเองครั้งแรก MT5 จะจำข้อมูล Server ไว้
และครั้งต่อไป batch จะ Login อัตโนมัติได้เลย

ทำซ้ำสำหรับทุกบัญชี (ACC_001 ถึง ACC_010):

  1. เปิด File Explorer ไปที่   C:\MT5_Accounts\ACC_001\
  2. ดับเบิ้ลคลิก  terminal64.exe  เพื่อเปิด MT5
  3. MT5 จะเปิดขึ้นมาพร้อมหน้า Login — ใส่ข้อมูล:
       Login:    เลขบัญชี MT5 ของบัญชีนี้
       Password: รหัสผ่าน
       Server:   ชื่อ Server โบรกเกอร์ (ค้นหาในช่อง Search ได้เลย)
  4. กด Login — รอจนกว่าจะเชื่อมต่อสำเร็จ (เห็น Balance ขึ้นมุมล่างขวา)
  5. ปิด MT5 ได้เลย (กด X มุมบนขวา)
  6. ทำซ้ำข้อ 1-5 สำหรับ ACC_002, ACC_003, ... จนถึง ACC_010

  หมายเหตุ: ถ้าหน้าต่าง Server ไม่มีโบรกเกอร์ของคุณ
  ให้กด "Scan" หรือพิมพ์ชื่อโบรกเกอร์ในช่องค้นหา
  ชื่อ Server ที่ถูกต้องจะขึ้นให้เลือก


===============================================================
ขั้นตอนที่ 4 — ใส่ข้อมูลบัญชี MT5 ใน run_reports.bat
===============================================================
...
===============================================================
ขั้นตอนที่ 7 — ตั้งให้รันอัตโนมัติทุก 1 ชั่วโมง (Task Scheduler)
===============================================================
